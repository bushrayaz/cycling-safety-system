...
# Then point YOLO_MODEL_PATH at the exported foler / .pt file
...
class CameraHazardDetector:
    ...
    def _init_camera(self):
        ...
        try:
            ...
            config = self._camera.create_preview_configuration(main={"format": "RGB888", "size": CAMERA_RESOLUTION})
    ...
    def _init_model(self):
        ...
        try:
            ...
            printf("[Camera] YOLO model loaded successfully.")
        except Exception as e:
    ...
    def detect_hazards(self, frame):
        ...
        Return:
          (hazard_class: bool, confidence: float) tuples for each valid detection
        '''
        ...
        for result in results:
            for box in result.boxes:
                ...
                if label in HAZARD_CLASSES and conf >= MIN_DETECTION_CONFIDENCE:
                    hazard_found = True
                    if conf > best_conf:
                        best_conf = conf
